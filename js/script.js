...
function calcularPrecio() {
    ...
    let dias = document.getElementById("dias").value ? parseInt(document.getElementById("dias").value) : 0;

    if (autoIndex === "" || !dias) return
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (dias) {
        dias.addEventListener("input", calcularPrecio)
    }
